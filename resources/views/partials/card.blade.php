<v-touch class="card"
    ...
    <div class="card-image">
        ...
        <object v-if="selectedFileIs('pdf') || selectedFileIs('text')"
            ...
            <p v-if="selectedFileIs('pdf')">{{ trans('media::messages.pdf') }}</p>
        </object>
    ...
    <div class="card-content">
        ...
        <p class="title is-marginless">
            ...
            <a :href="selectedFile.path"
                ...
                rel="noreferrer noopener"
                target="_blank"
                title="{{ trans('media::messages.public_url') }}"
                v-tippy>
            ...
            <div class="level-left">
                ...
                <div class="level-item">
                    <span v-if="$refs.lock"
                        ...
                        :title="IsLocked(selectedFile) ? '{{ trans('media::messages.unlock') }}': '{{ trans('media::messages.lock') }}'"
                ...
                <div class="level-item">
                    <span v-if="$refs.vis"
                        ...
                        title="{{ trans('media::messages.visibility.set') }}"
                        v-tippy
            ...
            <div class="level-right">
                ...
                <div class="level-item">
                    <span class="icon is-large link is-black"
                        title="{{ trans('media::messages.download.file') }}"
                        v-tippy
    ...
    <footer class="card-footer">
        ...
        <div class="card-footer-item">
            <button class="button btn-plain is-fullwidth"
                ...
                <span>{{ trans('media::messages.move.main') }}</span>
            </button>
        </div>
        ...
        <div class="card-footer-item">
            <button class="button btn-plain is-fullwidth"
                ...
                <span>{{ trans('media::messages.rename.main') }}</span>
            </button>
        </div>
        ...
        <div class="card-footer-item" v-if="selectedFileIs('image')">
            <button class="button btn-plain is-fullwidth"
                ...
                <span>{{ trans('media::messages.editor.main') }}</span>
            </button>
        </div>
        ...
        <div class="card-footer-item">
            <button class="button btn-plain is-fullwidth"
                ...
                <span>{{ trans('media::messages.delete.main') }}</span>
            </button>
        </div>
    </footer>
</v-touch>
